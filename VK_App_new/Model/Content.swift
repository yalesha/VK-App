...
//  static var groupsInstagram = Group(name: "Instagram", avatarPath: "instagram")
//    static var groupsFacebook = Group(from: <#Decoder#>, name: "Facebook", avatarPath: "facebook")
//  static var groupsBadoo = Group(name: "Badoo", avatarPath: "badoo")
//  static var groupsTelegram = Group(name: "Telegram", avatarPath: "telegram")
//  static var groupsViber = Group(name: "Viber", avatarPath: "viber")
//  static var groupsTwitter = Group(name: "Twitter", avatarPath: "twitter")
...
//  static func getUserGroups(userId: String) -> [Group]? {
//    return userGroupsDataBase[userId]
//  }
  
//  static func getAvailableGroups() -> [Group]? {
//    return availableGroupsDataBase
//  }
  
//  static func updateUserGroups(userId: String, updatedGroupsArray: [Group]) {
