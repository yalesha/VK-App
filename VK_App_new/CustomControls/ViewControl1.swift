...
public class ViewControl1 : NSObject {
    ...
    @objc @IBOutlet dynamic var canvas1Targets: [AnyObject]! {
        ...
        set {
            ...
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: ViewControl1.imageOfCanvas1)
            }
        }
    }
    ...
    @objc(ViewControl1ResizingBehavior)
